...
def _get_tool_description(tool_name: str) -> str:
    """Get tool description from generated tool definitions."""
...
class TestDescriptionAccuracy:
    ...
    def test_trigger_description_promotes_inline_recipients(self):
        ...
        desc = _get_tool_description("honeycomb_create_trigger")
    ...
    def test_slo_description_promotes_inline_derived_column(self):
        ...
        desc = _get_tool_description("honeycomb_create_slo")
    ...
    def test_board_description_promotes_inline_panels(self):
        ...
        desc = _get_tool_description("honeycomb_create_board")
    ...
    def test_batch_events_description_clarifies_structure(self):
        ...
        desc = _get_tool_description("honeycomb_send_batch_events")
    ...
    def test_single_event_description_clarifies_flat_structure(self):
        ...
        desc = _get_tool_description("honeycomb_send_event")
...
class TestDescriptionConsistency:
    ...
    def test_create_vs_list_descriptions_are_complementary(self):
        ...
        list_desc = _get_tool_description("honeycomb_list_triggers")
        create_desc = _get_tool_description("honeycomb_create_trigger")
    ...
    def test_all_descriptions_follow_format(self):
        ...
        # Get descriptions from actual tool definitions instead of central file
        tools = generate_all_tools()
