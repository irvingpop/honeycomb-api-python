...
from ..models.slo_detailed_response_status import SLODetailedResponseStatus
...
T = TypeVar("T", bound="SLODetailedResponse")



@_attrs_define
class SLODetailedResponse:
    """ 
        Attributes:
            ...
            compliance (Union[Unset, float]): Reporting data to express historical compliance of the SLO. Only included when
                the `?detailed` query param is passed.
                 Example: 95.39.
            budget_remaining (Union[Unset, float]): Reporting data to express how much error budget remains for the time
                period of the SLO. Only included when the `?detailed` query param is passed.
                 Example: 7.73.
            status (Union[Unset, SLODetailedResponseStatus]): Reporting data to express the status of the SLO.
                ...
                Only included when the `?detailed` query param is passed.
                 Example: normal.
            burn_rate (Union[Unset, float]): Reporting data to express the ratio of actual failures in the SLO
    ...
    status: Union[Unset, SLODetailedResponseStatus] = UNSET
    burn_rate: Union[Unset, float] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        status: Union[Unset, SLODetailedResponseStatus]
        if isinstance(_status,  Unset):
            status = UNSET
        else:
            status = SLODetailedResponseStatus(_status)




        burn_rate = d.pop("burn_rate", UNSET)

        slo_detailed_response = cls(
            name=name,
            sli=sli,
            time_period_days=time_period_days,
            target_per_million=target_per_million,
        ...
        slo_detailed_response.additional_properties = d
        return slo_detailed_response
