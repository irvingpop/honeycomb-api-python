...
T = TypeVar("T", bound="QueryResultLinks")



@_attrs_define
class QueryResultLinks:
    """ An object containing UI links to the query result and query result graph

        Attributes:
            query_url (Union[Unset, str]):  Example: https://ui.honeycomb.io/myteam/datasets/test-via-
                curl/result/HprJhV1fYy.
            graph_image_url (Union[Unset, str]):  Example: https://ui.honeycomb.io/myteam/datasets/test-via-
                curl/result/HprJhV1fYy/snapshot.
     """
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        query_result_links = cls(
            query_url=query_url,
            graph_image_url=graph_image_url,
        )


        query_result_links.additional_properties = d
        return query_result_links
