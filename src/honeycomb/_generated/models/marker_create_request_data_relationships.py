...
T = TypeVar("T", bound="MarkerCreateRequestDataRelationships")



@_attrs_define
class MarkerCreateRequestDataRelationships:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        marker_create_request_data_relationships = cls(
            environment=environment,
            dataset=dataset,
        )


        marker_create_request_data_relationships.additional_properties = d
        return marker_create_request_data_relationships
