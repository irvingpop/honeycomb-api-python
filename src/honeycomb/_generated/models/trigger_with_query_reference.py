...
T = TypeVar("T", bound="TriggerWithQueryReference")



@_attrs_define
class TriggerWithQueryReference:
    """ 
        Attributes:
            ...
            query_id (Union[Unset, str]): The ID of a Query that meets the criteria for being used as a Trigger, per above.
     """
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        trigger_with_query_reference = cls(
            id=id,
        ...
        trigger_with_query_reference.additional_properties = d
        return trigger_with_query_reference
