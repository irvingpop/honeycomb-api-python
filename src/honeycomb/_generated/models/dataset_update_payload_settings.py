...
T = TypeVar("T", bound="DatasetUpdatePayloadSettings")



@_attrs_define
class DatasetUpdatePayloadSettings:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        dataset_update_payload_settings = cls(
            delete_protected=delete_protected,
        )


        dataset_update_payload_settings.additional_properties = d
        return dataset_update_payload_settings
