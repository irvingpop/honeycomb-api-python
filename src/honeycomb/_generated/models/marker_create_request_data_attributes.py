...
T = TypeVar("T", bound="MarkerCreateRequestDataAttributes")



@_attrs_define
class MarkerCreateRequestDataAttributes:
    """ 
        Attributes:
            ...
            type_ (Union[Unset, str]): Groups similar Markers. For example, "deploys". Example: deploy.
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        marker_create_request_data_attributes = cls(
            start_time=start_time,
            end_time=end_time,
            message=message,
            type_=type_,
        ...
        marker_create_request_data_attributes.additional_properties = d
        return marker_create_request_data_attributes
