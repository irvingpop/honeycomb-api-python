...
T = TypeVar("T", bound="CreateBoardViewRequest")



@_attrs_define
class CreateBoardViewRequest:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        create_board_view_request = cls(
            name=name,
            filters=filters,
        )


        create_board_view_request.additional_properties = d
        return create_board_view_request
