...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[Union[Error, Union['EmailRecipient', 'MSTeamsRecipient', 'MSTeamsWorkflowRecipient', 'PagerDutyRecipient', 'SlackRecipient', 'WebhookRecipient']]]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Response[Union[Error, Union['EmailRecipient', 'MSTeamsRecipient', 'MSTeamsWorkflowRecipient', 'PagerDutyRecipient', 'SlackRecipient', 'WebhookRecipient']]]:
    return Response(
...
) -> Response[Union[Error, Union['EmailRecipient', 'MSTeamsRecipient', 'MSTeamsWorkflowRecipient', 'PagerDutyRecipient', 'SlackRecipient', 'WebhookRecipient']]]:
...
def sync(
    ...
    *,
...
) -> Optional[Union[Error, Union['EmailRecipient', 'MSTeamsRecipient', 'MSTeamsWorkflowRecipient', 'PagerDutyRecipient', 'SlackRecipient', 'WebhookRecipient']]]:
    """ Get a single Recipient
    ...
    Returns:
        Union[Error, Union['EmailRecipient', 'MSTeamsRecipient', 'MSTeamsWorkflowRecipient', 'PagerDutyRecipient', 'SlackRecipient', 'WebhookRecipient']]
     """
