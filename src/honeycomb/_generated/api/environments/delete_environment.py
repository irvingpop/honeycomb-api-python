...
def sync_detailed(
    ...
    *,
    ...
    Environments with Deletion Protection enabled cannot be deleted. To delete an Environment with
    Deletion Protection enabled, first disable Deletion Protection by updating the Environment with
