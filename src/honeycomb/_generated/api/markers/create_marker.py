...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[Union[Error, Marker]]:
    if response.status_code == 201:
        response_201 = Marker.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    """ Create a Marker
     ...
     Create a Marker in the specified dataset. To create an environment marker, use the `__all__` keyword
    and an API key associated with the desired environment.
