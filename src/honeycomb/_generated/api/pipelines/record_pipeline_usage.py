...
from ...models.create_pipeline_health_record_request import CreatePipelineHealthRecordRequest
...
def _get_kwargs(
    ...
    pipeline_id: str,
    *,
    body: CreatePipelineHealthRecordRequest,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/2/teams/{team_slug}/pipelines/{pipeline_id}/health".format(team_slug=team_slug,pipeline_id=pipeline_id,),
    }
